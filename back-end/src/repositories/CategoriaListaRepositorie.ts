...
class TransactionsRepository extends Repository<CategoriaLista> {
  public async createCategoriaLista(
    categoriaLista: CategoriaLista,
  ): Promise<void> {
    await this.create(categoriaLista);
  }

  public async deleteCategoriaLista(
    categoriaLista: CategoriaLista,
  ): Promise<void> {
    await this.delete(categoriaLista);
  }

  public async updateCategoriaLista(
    categoriaLista: CategoriaLista,
    newCategoriaLista: CategoriaLista,
  ): Promise<void> {
  ...
  public async getCategoriaLista(): Promise<ArrayCatLista> {
    const list: ArrayCatLista = { arrayCatList: new Array<CategoriaLista>() };
