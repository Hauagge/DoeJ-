...
class TransactionsRepository extends Repository<Cartao> 
{
    ...
    {
        if(newCartao.descricao != null)
        cartao.descricao = newCartao.descricao;
        
        if(newCartao.numero != null)
        cartao.numero = newCartao.numero;
        
        if(newCartao.agencia != null)
        cartao.agencia = newCartao.agencia;

        if(newCartao.conta != null)
        cartao.conta = newCartao.conta;
    ...
    public async deleteCartao(cartao: Cartao): Promise<void>
    {
     ...
     public async getAccCartoes(user : User): Promise<ArrayCartao>
     {
         var list:ArrayCartao = {arrayCartao:new Array<Cartao>()};
